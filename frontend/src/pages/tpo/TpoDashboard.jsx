...
const placementData = [
  { name: 'Placed', value: 72, color: '#fa5b31' },
  { name: 'Awaiting', value: 28, color: '#363531' },
];

const skillsData = [
  { name: 'Architecture', score: 88 },
  { name: 'Full Stack', score: 74 },
  { name: 'Data Intel', score: 92 },
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div className="glass-card p-6 rounded-2xl border border-white/5 relative overflow-hidden group">
          ...
          <h3 className="text-3xl font-black text-white">4,829</h3>
        </div>
        <div className="glass-card p-6 rounded-2xl border border-white/5">
          ...
          <h3 className="text-3xl font-black text-white">8.42</h3>
        </div>
        <div className="glass-card p-6 rounded-2xl border border-white/5">
          <div className="flex justify-between items-start mb-4">
            <div className="p-2 bg-primary-container/10 rounded-lg text-primary-container">
        ...
        <div className="glass-card p-6 rounded-2xl border border-white/5">
          ...
          <h3 className="text-3xl font-black text-white">12.4 <span className="text-sm font-medium opacity-50">LPA</span></h3>
        </div>
      </div>
